...
RUN apt-get install -qy \
    ...
    && cmake \
        ...
        -D PYTHON_INCLUDE_DIR=/usr/include/python3.8m \
        -D PYTHON_INCLUDE_DIR2=/usr/include/x86_64-linux-gnu/python3.8m \
...
RUN apt-get install -qy \
    ros-noetic-ros-base \
    ros-neotic-geometry2 \
    # libpcl-dev \
    ros-neotic-pcl-ros \
    ros-neotic-vision-opencv \
    ros-neotic-xacro \
    ros-neotic-rospy-message-converter \
    ros-neotic-image-transport \
    ros-neotic-rgbd-launch \
    ros-neotic-ddynamic-reconfigure \
    ros-neotic-diagnostic-updater \
    ros-neotic-robot-state-publisher \
    ros-neotic-joint-state-publisher
    # dirmngr \
    # librosconsole-dev \
    # libxmlrpcpp-dev \
    # lsb-release \
